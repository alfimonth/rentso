              ...
              <div class="col-md-12">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                    <?php
                    $sql = "SELECT kendaraan.*,merek.* FROM kendaraan, merek WHERE kendaraan.id_merek=merek.id_merek AND kendaraan.id_mobil='$id'";
                    ...
                    <form method="post" class="form-horizontal" name="theform" action="" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <textarea class="form-control" name="vehicalorcview" rows="3" required><?= htmlentities($result['deskripsi']); ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="priceperday" class="form-control" value="<?= htmlentities($result['harga']); ?>" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="modelyear" class="form-control" value="<?= htmlentities($result['tahun']); ?>" required>
                        </div>
                        <label class="col-sm-2 control-label">Jumlah Tempat Duduk<span style="color:red">*</span></label>
                        <div class="col-sm-4">
                          <input type="text" name="seatingcapacity" class="form-control" value="<?= htmlentities($result['seating']); ?>" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-4">
                          Gambar 1 <img src="<?= base_url('assets/'); ?>images/vehicleimages/<?= htmlentities($result['image1']); ?>" width="300" height="200" style="border:solid 1px #000">
                          <a href="<?= base_url('mobil/ubahgambar1/') . htmlentities($result['id_mobil']) ?>">Ganti Gambar 1</a>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                          ...
                          <a href="<?= base_url('mobil/ubahgambar3/') . htmlentities($result['id_mobil']) ?>">Ganti Gambar 3</a>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-sm-4">
                          Gambar 4<img src="<?= base_url('assets/'); ?>images/vehicleimages/<?= htmlentities($result['image4']); ?>" width="300" height="200" style="border:solid 1px #000">
                          <a href="<?= base_url('mobil/ubahgambar4/') . htmlentities($result['id_mobil']) ?>">Ganti Gambar 4</a>
                        </div>
                        <div class="col-sm-4">
                          Gambar 5
                          <?php if ($result['image5'] == "") {
                            ...
                            <img src="<?= base_url('assets/'); ?>images/vehicleimages/<?= htmlentities($result['image5']); ?>" width="300" height="200" style="border:solid 1px #000">
                            <a href="<?= base_url('mobil/ubahgambar5/') . htmlentities($result['id_mobil']) ?>">Ganti Gambar 5</a>
                          <?php } ?>
                        </div>
                      </div>
