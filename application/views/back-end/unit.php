...
<body>
	<div id="section-to-print">
		...
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Form Tambah Unit</h4>
		</div>
		<div><br /></div>
		<form id="theform" data-parsley-validate class="form-horizontal form-label-left" action="<?= base_url('/mobil/unit/') . $kendaraan['id_mobil'] ?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Warna</label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" id="nis" required class="form-control col-md-7 col-xs-12" name="warna" data-parsley-error-message="Field ini harus diisi" value="<?= set_value('warna') ?>">
				</div>
			</div>
