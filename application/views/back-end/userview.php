...
if ($kode != null) {
	$Kode = $kode;
	$mySql = "SELECT * FROM users WHERE id_user ='$Kode'";
	...
	<div id="section-to-print">
		...
		<form id="theform" data-parsley-validate class="form-horizontal form-label-left" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="<?= base_url('assets/'); ?>images/user/id/<?= htmlentities($result['ktp']); ?>" width="200" height="150">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">KK</label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="<?= base_url('assets/'); ?>images/user/id/<?= htmlentities($result['kk']); ?>" width="200" height="150">
				</div>
			</div>
		</form>
